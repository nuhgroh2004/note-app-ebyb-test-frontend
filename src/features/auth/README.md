...
- Jika frontend berjalan di `http://localhost:3000`, jalankan backend di port lain (contoh `http://localhost:4000`).
- Jika frontend berjalan di `http://localhost:4000`, backend bisa dijalankan di `http://localhost:3000`.
